...
if($_SERVER ['REQUEST_METHOD'] == 'POST'){
    ...
    //verificar se imagem que esta chegando é igual que sera gravada 
    if($imagem_atual == $imagem_base64){
       ...
       // echo $sql;
        ...
        pro_unidade = '$unidade', pro_preco = $preco, pro_status ='$status', pro_imagem ='$imagem_base64' WHERE pro_id = $id";
