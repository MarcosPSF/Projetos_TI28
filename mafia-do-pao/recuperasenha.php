<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($cont != 0){
            ...
            Acesse <a href='http://localhost/mafia-do-pao/redefinesenha.php'> aqui </a>
            ...
            try{
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'mmarcostest@sapo.pt'; //coloque seu email  real
                $mail->Password = 'Ribeirao02@'; //coloque sua senha de email real
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                $mail->Port = 587; //Porta usada pelo serviço SMTP
                $mail->setFrom('mmarcostest@sapo.pt', 'EMAIL REC');
                $mail->addAddress($to);
                $mail->isHTML(true);
