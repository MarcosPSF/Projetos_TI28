...
CREATE TABLE tb_produtos(
    ...
    cli_quantidade DECIMAL (10,2),
    cli_unidade VARCHAR (10) NOT NULL,
    cli_preco DECIMAL (10,2) NOT NULL,
...
ALTER TABLE tb_venda ADD CONSTRAINT ven_usu_id FOREIGN KEY (fk_usu_id) REFERENCES tb_usuario(usu_id);