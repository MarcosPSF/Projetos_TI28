...
<body>
    <div class="container-home">
        ...
        <div class="menu">
            ...
            <a href="cliente-cadastro.php"><span class="tooltiptext">Cadastro de cliente</span><img
                    src="icons/user-add.png"></a>
            <a href="adicionar-quadra.php"><span class="tooltiptext">Cadastro De Quadras</span><img
                    src="icons/quadra.png"></a>
